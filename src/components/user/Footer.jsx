...
const Footer = () => {
  return (
    <footer className="bg-[#B57BB5] text-[#F8F8F8] py-10 px-6 md:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-6">
        ...
        <nav>
          ...
          <ul className="space-y-2">
            <Link to={"/about"}>
              <li className="hover:text-gray-300 transition-colors duration-200 cursor-pointer mb-1">
                About True Self
              </li>
            </Link>

            <li className="hover:text-gray-300 transition-colors duration-200 cursor-pointer mb-2">
              Articles
            </li>
